...
async def help(_, message: Message):
    help_text = (
        ...
        "/active - Enable Markov chatbot in group\n"
        "/inactive - Disable Markov chatbot in group\n"
        "/markov - Generate Markov text or check stats\n"
        "/tts [text] - Convert text to voice notes (ElevenLabs)\n"
        "/voices - Browse & select ElevenLabs AI voices\n"
        "/enhance - AI 2x image enhancer & deblurrer (reply to image)\n"
        "/cats - Get cute cat pictures\n"
        "/afk - Set AFK status\n"
